...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_p2b_adapter.vho" -work p2b_adapter                     
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_b2p_adapter.vho" -work b2p_adapter                     
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_transacto.vho"   -work transacto                       
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_p2b.vho"         -work p2b                             
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_b2p.vho"         -work b2p                             
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_fifo.vho"        -work fifo                            
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0_timing_adt.vho"  -work timing_adt                      
  ...
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/AvalonJTAG2Memory_master_0.vhd"             -work master_0                        
  vhdlan -xlrm          "$QSYS_SIMDIR/AvalonJTAG2Memory.vhd"                                                                       
fi
