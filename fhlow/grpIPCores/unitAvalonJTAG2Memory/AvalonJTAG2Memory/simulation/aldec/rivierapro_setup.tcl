...
alias com {
  echo "\[exec\] com"
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/altera_reset_controller.v"            -work rst_controller                  
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/altera_reset_synchronizer.v"          -work rst_controller                  
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rst_controller -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L master_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
