...
# ACDS 15.0 145 win32 2016.08.22.16:05:35
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/submodules/AvalonSPI_spislave_0.vho" -work spislave_0
  vcom "$QSYS_SIMDIR/AvalonSPI.vhd"                                       
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L spislave_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L spislave_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
