...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/AvalonSPI_spislave_0.vho" -work spislave_0 -cdslib ./cds_libs/spislave_0.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/AvalonSPI.vhd"                                                                             
fi
