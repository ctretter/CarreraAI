	soc_system u0 (
		...
		.opticalsensor_external_connection_miso      (<connected-to-opticalsensor_external_connection_miso>),      // opticalsensor_external_connection.miso
		.opticalsensor_external_connection_mosi      (<connected-to-opticalsensor_external_connection_mosi>),      //                                  .mosi
		.opticalsensor_external_connection_select    (<connected-to-opticalsensor_external_connection_select>),    //                                  .select
		.opticalsensor_external_connection_sysclk    (<connected-to-opticalsensor_external_connection_sysclk>),    //                                  .sysclk
		.opticalsensor_external_connection_npd       (<connected-to-opticalsensor_external_connection_npd>),       //                                  .npd
		.opticalsensor_external_connection_sensorrst (<connected-to-opticalsensor_external_connection_sensorrst>)  //                                  .sensorrst
	);
