	soc_system u0 (
		.carleds_external_connection_export           (<connected-to-carleds_external_connection_export>),           //        carleds_external_connection.export
		.carsensors_external_connection_export        (<connected-to-carsensors_external_connection_export>),        //     carsensors_external_connection.export
		...
		.motor_control_0_external_pwm_outuput         (<connected-to-motor_control_0_external_pwm_outuput>),         //           motor_control_0_external.pwm_outuput
		.motor_control_0_external_enablesignal        (<connected-to-motor_control_0_external_enablesignal>),        //                                   .enablesignal
		.motor_control_0_external_sensorsignal        (<connected-to-motor_control_0_external_sensorsignal>),        //                                   .sensorsignal
		.motor_control_0_external_roundsignal         (<connected-to-motor_control_0_external_roundsignal>),         //                                   .roundsignal
		...
		.avalontoopticalsensor_sensor_ports_miso      (<connected-to-avalontoopticalsensor_sensor_ports_miso>),      // avalontoopticalsensor_sensor_ports.miso
		.avalontoopticalsensor_sensor_ports_mosi      (<connected-to-avalontoopticalsensor_sensor_ports_mosi>),      //                                   .mosi
		.avalontoopticalsensor_sensor_ports_select    (<connected-to-avalontoopticalsensor_sensor_ports_select>),    //                                   .select
		.avalontoopticalsensor_sensor_ports_sysclk    (<connected-to-avalontoopticalsensor_sensor_ports_sysclk>),    //                                   .sysclk
		.avalontoopticalsensor_sensor_ports_npd       (<connected-to-avalontoopticalsensor_sensor_ports_npd>),       //                                   .npd
		.avalontoopticalsensor_sensor_ports_sensorrst (<connected-to-avalontoopticalsensor_sensor_ports_sensorrst>)  //                                   .sensorrst
	);
