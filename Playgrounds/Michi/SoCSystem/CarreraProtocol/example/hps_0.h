...
#define SYSID_QSYS_TIMESTAMP 1451062444
...
/*
 * Macros for device 'PWM_Motor_Control_0', class 'PWM_Motor_Control'
 * The macros are prefixed with 'PWM_MOTOR_CONTROL_0_'.
 * The prefix is the slave descriptor.
 */
#define PWM_MOTOR_CONTROL_0_COMPONENT_TYPE PWM_Motor_Control
#define PWM_MOTOR_CONTROL_0_COMPONENT_NAME PWM_Motor_Control_0
#define PWM_MOTOR_CONTROL_0_BASE 0x40000
#define PWM_MOTOR_CONTROL_0_SPAN 32
#define PWM_MOTOR_CONTROL_0_END 0x4001f

/*
 * Macros for device 'CarreraProtocolDecoder_0', class 'CarreraProtocolDecoder'
 * The macros are prefixed with 'CARRERAPROTOCOLDECODER_0_'.
 * The prefix is the slave descriptor.
 */
#define CARRERAPROTOCOLDECODER_0_COMPONENT_TYPE CarreraProtocolDecoder
#define CARRERAPROTOCOLDECODER_0_COMPONENT_NAME CarreraProtocolDecoder_0
#define CARRERAPROTOCOLDECODER_0_BASE 0x40020
#define CARRERAPROTOCOLDECODER_0_SPAN 16
#define CARRERAPROTOCOLDECODER_0_END 0x4002f
